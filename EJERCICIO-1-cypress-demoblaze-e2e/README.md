...
Prueba E2E para https://www.demoblaze.com/
...
### PASO 3: Instalar el binario de Cypress (IMPORTANTE)
```bash
npx cypress install
```
...
### OPCIÓN 4: ABRIR CYPRESS EN MODO INTERACTIVO 
...
### OPCIÓN 5: EJECUTAR EN DIFERENTES NAVEGADORES
...
### OPCIÓN 6: GENERAR REPORTE HTML COMPLETO
...
3. Los tests son independientes y pueden ejecutarse en cualquier orden
4. Se recomienda usar "npm run open" para ver las pruebas en acción
